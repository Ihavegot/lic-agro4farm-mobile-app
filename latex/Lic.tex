...
\begin{document}
	...
	Po wykonaniu odpowiedniego zapytania, OpenWeather API zwraca użytkownikowi obiekt w formacie JSON z informacjami o pogodzie. Informacje które z takiego jesteśmy w stanie odczytać to opis pogody, koordynaty lokacji, wiatr, wilgotność, wschód i zachód słońca oraz wiele więcej.
